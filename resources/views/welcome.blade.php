            ...
            <div class="layer" id="layer-1">
                <div class="inputs">
                    ...
                    <div class="input-form">
                        ...
                        <input type="number" id="wave-length-1.1" min="1" max="100" value="1" step="1" />
                        <input type="number" id="wave-length-1.2" min="1" max="100" value="100" step="1" />
                    </div>
                    <div class="input-form">
                        <label for="wave-height-1">Wave Height:</label>
                        <input type="number" id="wave-height-1.1" min="1" max="100" value="1" step="1" />
                        <input type="number" id="wave-height-1.2" min="1" max="100" value="100" step="1" />
                    </div>
                    <div class="input-form">
                        <label for="wave-distortion-1">Wave Distortion:</label>
                        <input type="number" id="wave-distortion-1.1" min="1" max="100" value="1" step="1" />
                        <input type="number" id="wave-distortion-1.2" min="1" max="100" value="100" step="1" />
                    </div>
                    ...
                    <button class="try-again" data-id="1">Try Again</button>
                </div>
