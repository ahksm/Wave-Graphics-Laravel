...
<body>
    ...
    <script>
        document.getElementById('wave-length-1').value = ((Math.random() - 0.5) * 0.02 + 0.01).toFixed(3);
        document.getElementById('wave-height-1').value = Math.floor((Math.random() - 0.5) * 20 + 25);
        document.getElementById('wave-distortion-1').value = Math.floor((Math.random() - 0.5) * 40 + 50);
    </script>
